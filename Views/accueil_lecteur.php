...
<body>
    ...
    <nav class="nav-bar">
    <a href="../Views/accueil_lecteur_lecteur.php" class="nav-item active">accueil</a>
    ...
    <div class='form-contact'>
        ...
        <form action="../Views/accueil_lecteur.php" method="post">
    ...
    <div class='fin-page'>
    <a href="../Views/accueil_lecteur.php"><img src='../Content/IMG/carre-rouge.jpg'></a>
