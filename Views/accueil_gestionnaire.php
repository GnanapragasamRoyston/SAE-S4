...
<body>
    ...
    <nav class="nav-bar">
    <a href="../Views/accueil_gestionnaire.php" class="nav-item active">accueil</a>
    ...
    <div class='form-contact'>
        ...
        <form action="../Views/accueil_gestionnaire.php" method="post">
    ...
    <div class='fin-page'>
    <a href="../Views/accueil_gestionnaire.php"><img src='../Content/IMG/carre-rouge.jpg'></a>
