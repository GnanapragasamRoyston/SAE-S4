...
<body>
    ...
    <nav class="nav-bar">
    <a href="accueil_gestionnaire.php" class="nav-item active">Accueil</a>
    <a href="search_games_gestionnaire.php" class="nav-item">Jeux</a>
    <a href="dashboard_gestionnaire.php" class="nav-item">Compte</a>
    </nav>

    <div class='Search'>
        <form action='search_games_gestionnaire.php' method='GET'>
    ...
    <div class='Liste-jeux'>
        ...
        <br>
            ...
            <div class="jeux-img">
                <div class='jeu'>
                    <a href='../Views/search_games_gestionnaire.php'><img src='../Content/IMG/yellow.png' class="fleche"></a>
                </div>
